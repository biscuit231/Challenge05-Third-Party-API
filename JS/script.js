var currentBlock = $(".hour");
var now = parseInt(moment().format("H"));

// Add current day in header with momentjs
var today = moment().format("dddd, MMMM Do");
$("#currentDay").text(today);

// Function to check current time against each timeblock and add the proper class for color changes
$.each(currentBlock, function() {
...
// If Save button clicked, set item to local storage and upon refresh, retrieve item from local storage too if one there
